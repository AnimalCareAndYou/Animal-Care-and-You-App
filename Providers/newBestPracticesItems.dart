  ...
  Future<void> itemBuilder() async {
    ...
    List<BestPracticesItem> items = [
      BestPracticesItem(
        ...
        symptoms:
            "Parvovirus usually affects puppies. An infected dog may exhibit lethargic behaviour and a loss of appetite as initial signs. It might also have a fever. As the virus progresses, the dog is likely to suffer from severe vomitting, diarrhea and bloody stool. In extreme cases, puppies may collapse and have a highly elevated heart rate.",
        description:
