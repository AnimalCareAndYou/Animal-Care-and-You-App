...
class _NgoItemScreenState extends State<NgoItemScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.ngoItem.id == "n22") {
      websiteText = "INCARE'S";
    } else if (widget.ngoItem.id == "n30") {
      websiteText = "Awaaz's";
    }
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          padding: EdgeInsets.only(top: 0, bottom: 0, left: 4.5, right: 4.5),
          child: Column(
            ...
            children: [
              ...
              widget.ngoItem.emailAddress.isEmpty
                  ? Container()
                  : SizedBox(
                      height: 13.6,
                    ),
              widget.ngoItem.emailAddress.isEmpty
                  ...
                  : Container(
                      ...
                      child: Row(
                        children: [
                          buildRow(
                              Icons.email, "Email address: ", widget.color),
                          Flexible(
                            child: Container(
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
