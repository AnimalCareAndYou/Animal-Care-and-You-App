...
class _VetItemScreenState extends State<VetItemScreen> {
  ...
  Widget build(BuildContext context) {
    String cityText = "";
    if (widget.vetItem.city == City.DelhiNCR) {
      cityText = "Delhi NCR";
    } else if (widget.vetItem.city == City.Chennai) {
      cityText = "Chennai";
    } else if (widget.vetItem.city == City.Kolkata) {
      cityText = "Kolkata";
    } else {
      cityText = "Mumbai";
    }
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              buildNewListTile(
                  Entypo.location,
                  widget.vetItem.city == City.DelhiNCR ? "Region" : "City",
                  cityText),
              SizedBox(
                height: 14,
              ),
